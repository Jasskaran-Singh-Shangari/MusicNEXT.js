        ...
        {items.map((item, idx) => (
          <li
            ...
            <blockquote>
              ...
              <span
                className="relative z-20 text-lg leading-[1.6] font-normal text-neutral-800 dark:text-gray-400">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span
                    className="text-md leading-[1.6] font-normal text-neutral-500 dark:text-gray-400">
                    {item.name}
                  </span>
                  <span
